...
class appAppKernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('q70OC8ORhV', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0NzW1sxSSg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = (new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))->createConnection(['driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => '', 'dbname' => 'asgarage', 'user' => 'root', 'password' => '', 'charset' => 'utf8mb4', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))', 1013 => $this->getEnv('const:runtime:_PS_ALLOW_MULTI_STATEMENTS_QUERIES_')], 'defaultTableOptions' => []], $a, $c, ['enum' => 'string']);
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $d = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'productcomments'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity')]);
        $d->addExcludePaths([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'modules'.\DIRECTORY_SEPARATOR.'productcomments'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Entity/index.php')]);

        $b->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($c, [0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'PrestaShopBundle'.\DIRECTORY_SEPARATOR.'Entity')]), 'PrestaShopBundle\\Entity');
    ...
    {
        return $this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, (\dirname(__DIR__, 4).'/var/cache/dev'.\DIRECTORY_SEPARATOR.'/localization'));
    }
    ...
    {
        $this->services['prestashop.core.localization.cldr.datalayer.locale_cache'] = $instance = new \PrestaShop\PrestaShop\Core\Localization\CLDR\DataLayer\LocaleCache(($this->services['prestashop.core.localization.cldr.cache.adapter'] ?? ($this->services['prestashop.core.localization.cldr.cache.adapter'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CLDR', 0, (\dirname(__DIR__, 4).'/var/cache/dev'.\DIRECTORY_SEPARATOR.'/localization')))));
    ...
    protected function getTwigService()
    {
        ...
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../src/PrestaShopBundle/Resources/views/Admin/Product'), 'Product');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../src/PrestaShopBundle/Resources/views/Admin/TwigTemplateForm'), 'Twig');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../src/PrestaShopBundle/Resources/views/Admin/Common'), 'Common');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../src/PrestaShopBundle/Resources/views/Admin/Configure/AdvancedParameters'), 'AdvancedParameters');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../src/PrestaShopBundle/Resources/views/Admin/Configure/ShopParameters'), 'ShopParameters');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../modules'), 'Modules');
        $b->addPath((\dirname(__DIR__, 4).'/mails/themes'), 'MailThemes');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/../src/PrestaShopBundle/Resources/views'), 'PrestaShopCore');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'FrameworkBundle/Resources/views'), 'Framework');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'FrameworkBundle/Resources/views'), '!Framework');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'SecurityBundle/Resources/views'), 'Security');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'SecurityBundle/Resources/views'), '!Security');
        $b->addPath((\dirname(__DIR__, 4).'/templates/bundles/TwigBundle'), 'Twig');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'TwigBundle/Resources/views'), 'Twig');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'TwigBundle/Resources/views'), '!Twig');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'swiftmailer-bundle/Resources/views'), 'Swiftmailer');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'swiftmailer-bundle/Resources/views'), '!Swiftmailer');
        ...
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'doctrine'.\DIRECTORY_SEPARATOR.'doctrine-bundle/Resources/views'), '!Doctrine');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle/Resources/views'), 'ApiPlatform');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'api-platform'.\DIRECTORY_SEPARATOR.'core'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle/Resources/views'), '!ApiPlatform');
        $b->addPath((\dirname(__DIR__, 4).'/templates/bundles/PrestaShopBundle'), 'PrestaShop');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'PrestaShopBundle/Resources/views'), 'PrestaShop');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'PrestaShopBundle/Resources/views'), '!PrestaShop');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'DebugBundle/Resources/views'), 'Debug');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'DebugBundle/Resources/views'), '!Debug');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'WebProfilerBundle/Resources/views'), 'WebProfiler');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'WebProfilerBundle/Resources/views'), '!WebProfiler');
        $b->addPath((\dirname(__DIR__, 4).'/templates'));
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bridge'.\DIRECTORY_SEPARATOR.'Twig/Resources/views/Email'), 'email');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bridge'.\DIRECTORY_SEPARATOR.'Twig/Resources/views/Email'), '!email');
        $b->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bridge'.\DIRECTORY_SEPARATOR.'Twig/Resources/views/Form'));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('', new \Symfony\Component\Asset\VersionStrategy\StaticVersionStrategy('8.1.4', '%s?%s'), new \Symfony\Component\Asset\Context\RequestStackContext($d, '', false)), [])));
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9RQgbC6g67', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('x5PV12H3U0', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('1Tw8MMQpl1', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('XbAMydURXY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tbixuSCvq4', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('81maMo9siY', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.metadata.property.name_collection_factory.cached'] = new \ApiPlatform\Metadata\Property\Factory\CachedPropertyNameCollectionFactory(($this->privates['api_platform.cache.metadata.property'] ?? $this->getApiPlatform_Cache_Metadata_PropertyService()), new \ApiPlatform\Metadata\Property\Factory\ExtractorPropertyNameCollectionFactory(($this->privates['api_platform.metadata.property_extractor.yaml'] ?? ($this->privates['api_platform.metadata.property_extractor.yaml'] = new \ApiPlatform\Metadata\Extractor\YamlPropertyExtractor([0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app'.\DIRECTORY_SEPARATOR.'config'.\DIRECTORY_SEPARATOR.'api_platform'.\DIRECTORY_SEPARATOR.'resources.yml')], $this))), new \ApiPlatform\Metadata\Property\Factory\ExtractorPropertyNameCollectionFactory(($this->privates['api_platform.metadata.property_extractor.xml'] ?? ($this->privates['api_platform.metadata.property_extractor.xml'] = new \ApiPlatform\Metadata\Extractor\XmlPropertyExtractor([], $this))), new \ApiPlatform\Metadata\Property\Factory\PropertyInfoPropertyNameCollectionFactory(($this->privates['property_info'] ?? $this->getPropertyInfoService())))));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('YY0hQSTwYV', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6rXUdrcRmq', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vlBI9Bwr+v', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('2Z5J1JuGac', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('jqhx+NXwGo', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(($this->privates['uri_signer'] ?? ($this->privates['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('h7OVLef6Yy7oOEYBzBqyuviHHQXViftZKccSvPovRmJBDE0twSX9TwMxboK3Zq9G'))), '/_fragment');
    }
    ...
    {
        return $this->privates['locale_listener'] = new \Symfony\Component\HttpKernel\EventListener\LocaleListener(($this->services['request_stack'] ?? ($this->services['request_stack'] = new \Symfony\Component\HttpFoundation\RequestStack())), 'pt-PT', ($this->services['prestashop.router'] ?? $this->load('getPrestashop_RouterService.php')));
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles_metadata' => [
                ...
                'DebugBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'DebugBundle'),
                    'namespace' => 'Symfony\\Bundle\\DebugBundle',
                ],
                'WebProfilerBundle' => [
                    'path' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Symfony'.\DIRECTORY_SEPARATOR.'Bundle'.\DIRECTORY_SEPARATOR.'WebProfilerBundle'),
            ...
            'secret' => 'h7OVLef6Yy7oOEYBzBqyuviHHQXViftZKccSvPovRmJBDE0twSX9TwMxboK3Zq9G',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2024-03-06',
            'locale' => 'pt-PT',
            'use_debug_toolbar' => true,
            'cookie_key' => 'QOVu2Q3Hs2kUJ23gJgVz3pZC3XORvw24quAhYamWasjNYUXgtc7P4FOVR72KrJGY',
            'cookie_iv' => 'WxSrGuDTaX4VWxSZVtBivxSfnMjK3Qcc',
            'new_cookie_key' => 'def00000d793e7fe1974a5c710b82f1f00d8d5710e1a095c3d579bf04a9b7a0158bada21536c94efda37172aeaa185fc899c3448c259a38de4222b5b6e8d875b19b0a9b5',
            ...
            'api_private_key' => '-----BEGIN PRIVATE KEY-----'."\n".'MIIEvAIBADANBgkqhkiG9w0BAQEFAASCBKYwggSiAgEAAoIBAQDG4DE6X0vDXwKH'."\n".'TZ97bDsXu9Ngvlvt7/vD4rYj6e2PK0YotF3ZjsbozxZvdbdMydTfCzGMsG7E1kHQ'."\n".'zNkuDPOzc8PmE+WXroxJwdl44fQWp5JjHx3D6EnDLubcyap2g4rjWG2KM/uwyxUL'."\n".'vEO5RzzRMyTzYpqdjEm5m6Je/jrxuhlSvWAjcxclTOcUcoTmdFagGyO6EmJILLzv'."\n".'N1gZeexwQdmJbCVxJRFrf55M2FDR8r6bQCklLgmLdE7XGhknZforzlh6Vz7xjSx5'."\n".'XVF+wUnNmJG3C5Tlx7v7vPj6yk7vLT9B7MeQKM9KNk3BhVU+s5pHyEYh2F17W6Tp'."\n".'p5qWy6sJAgMBAAECggEAFu9n/flbfW6Jlh0HlW5H6lbI69FIPMp+WHre0ol50hcF'."\n".'glA6uopSuiqXxcbnmr10BTz/O+BlBeJHuNLHAR6RRFLHdtM4mSOSHjdy4xP72Fj+'."\n".'8tt1zVAOoanZCgFf3UcST2G1UEjqb9sb1Dyj+swSYXXqfv8SIbU6E2O1eAsNtS6y'."\n".'/VLQhMV8Tw1GBI8j23QgGJ+MYgh4yiI64PR4p6rbd4flCWj/f9pQWd4/wVD/t9Rw'."\n".'/E4kllN1saZ2apxt1cj3w5L2JxLz30oaBaWz1OypCYSnZ0zvuWNY+ZAjKcik6P2N'."\n".'69Wftfr/sRJuLhB4iNn3vNU7j2T+/nZKJ1MbUvmTeQKBgQDtH7oimz5sswAD74bj'."\n".'VOFzVHdTgy4PwJ7uRW2hGtbqqOeb/5bYnPVUSrgUCLf1LnqlYzDEYMkFz+Rx5cOX'."\n".'zjsKAWTMWo4gzAmF0ovG9qwQPiwl/fsTFzknuhM9VKYAymcVdLgjNc6IPnKc39tN'."\n".'mokPZarkRmuq7JLuNHYPLPAT5wKBgQDWtQSIZuBKGRjkb99bBz5cMOS+nY+dtBga'."\n".'kBFVCK3gB5gjWHKRbGktgdWks1Wi8ZI4OEr6H8csVzrGnnW4NnTLBjaL2hvMtiVg'."\n".'V9b6a+KfTcqNUyr1tCswK2fcxyOatJOHTq1xWyQ62ZAYpY3ldEFIvTrWSSYqAbM3'."\n".'6AaS3MlrjwKBgBNI60h5O8B3Zl7rkhrXAmbwzaubFZnuXn6eYuYhWq1HA18qkEgZ'."\n".'q9IpKYNnmh50o0DkKkkuXer9F2Uz/I5SFXcg2ePM0ZZVQckCcJ/D3AaOJ+UHHO5W'."\n".'iy1x8rKgOcgCrhOOpJMogx2NhqC/jARptw/rgtSB7au/BcwdtCRT0UqtAoGAGyVb'."\n".'41sOdI/jw84ZMUsjKUjNQwRsygWhHoqkhlnIkhCjvaRLJ/PLAIPv3RkHdMiSMiV7'."\n".'5U/rQMHunnoebCIGdjzc3KXA6gsFgr7YYWUOjBGr0F55igMziq2SPim3aLH4DR13'."\n".'dGOPmxkyzMrxu9cNAgNa0wkAmEMKw8DERAFCPiUCgYAQXwAYdpYSeALBijxqYkEf'."\n".'UyIwzw8tC2gEQoGLPQUjtNwXR/Cr59VzlxxG8U6EoXcU46f8vbuoJQ8P10mRiM2P'."\n".'/AUQd4pSbHgnC8hBhyRxYBhGy2pqLY97J9oTz/jo9gwdMeS0+SFDsDJH/720fjgR'."\n".'DP4t8S2Uvi3E6/bpfbmDHQ=='."\n".'-----END PRIVATE KEY-----'."\n".'',
            'cache.driver' => 'array',
            ...
            'env(PS_LOG_OUTPUT)' => (\dirname(__DIR__, 3).''.\DIRECTORY_SEPARATOR.'logs/dev.log'),
            ...
            'kernel.secret' => 'h7OVLef6Yy7oOEYBzBqyuviHHQXViftZKccSvPovRmJBDE0twSX9TwMxboK3Zq9G',
            ...
            'router.resource' => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'app/config/routing_dev.yml'),
            ...
            'api_platform.resource_class_directories' => [
                0 => (\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'PrestaShopBundle/Entity'),
            ...
            'ps_cache_dir' => (\dirname(__DIR__, 4).'/var/cache/dev'.\DIRECTORY_SEPARATOR.''),
