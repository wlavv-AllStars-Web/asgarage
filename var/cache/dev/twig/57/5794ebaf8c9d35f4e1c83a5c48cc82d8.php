...
class __TwigTemplate_6982d1d0ad5d2d105e71ab1bf65de1cf extends Template
{
    private $source;
    private $macros = [];
  ...
  <div class=\"product-header-cover\">
    ";
        // line 27
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, (isset($context["productForm"]) || array_key_exists("productForm", $context) ? $context["productForm"] : (function () { throw new RuntimeError('Variable "productForm" does not exist.', 27, $this->source); })()), "header", [], "any", false, false, false, 27), "cover_thumbnail", [], "any", false, false, false, 27), 'row');
        echo "
  </div>
...
";
    ...
    public function block_product_header_form($context, array $blocks = [])
    {
        ...
        // line 31
        echo "      ";
        echo $this->env->getRuntime('Symfony\Component\Form\FormRenderer')->searchAndRenderBlock(twig_get_attribute($this->env, $this->source, (isset($context["productForm"]) || array_key_exists("productForm", $context) ? $context["productForm"] : (function () { throw new RuntimeError('Variable "productForm" does not exist.', 31, $this->source); })()), "header", [], "any", false, false, false, 31), 'row');
        echo "
    ";
    ...
    {
        return array (  83 => 31,  73 => 30,  62 => 36,  60 => 35,  56 => 33,  54 => 30,  48 => 27,  44 => 25,);
    }
...
", "@PrestaShop/Admin/Sell/Catalog/Product/Blocks/header.html.twig", "C:\\xampp\\htdocs\\asgarage\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Catalog\\Product\\Blocks\\header.html.twig");
    }
}
