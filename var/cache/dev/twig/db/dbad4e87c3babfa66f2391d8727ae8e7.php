...
class __TwigTemplate_8b35933f546013c61b8a7d85040108fe extends Template
{
    private $source;
    private $macros = [];
    ...
    public function block_grid_view_block($context, array $blocks = [])
    {
        ...
        // line 29
        echo "  ";
        echo twig_include($this->env, $context, "@PrestaShop/Admin/Sell/Catalog/Product/Grid/grid.html.twig", ["grid" => (isset($context["grid"]) || array_key_exists("grid", $context) ? $context["grid"] : (function () { throw new RuntimeError('Variable "grid" does not exist.', 29, $this->source); })())]);
        echo "
";
    ...
    {
        return array (  68 => 29,  58 => 28,  35 => 26,);
    }
...
{% extends '@PrestaShop/Admin/Common/Grid/grid_panel.html.twig' %}

{% block grid_view_block %}
  {{ include('@PrestaShop/Admin/Sell/Catalog/Product/Grid/grid.html.twig', {'grid': grid }) }}
{% endblock %}
", "@PrestaShop/Admin/Sell/Catalog/Product/Grid/grid_panel.html.twig", "C:\\xampp\\htdocs\\asgarage\\src\\PrestaShopBundle\\Resources\\views\\Admin\\Sell\\Catalog\\Product\\Grid\\grid_panel.html.twig");
    }
}
